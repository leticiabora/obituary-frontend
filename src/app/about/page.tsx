  ...
  return (
    <Container>
      ...
      <Text>
        ...
        <p>
          Exactly 1 year before (28th April, 2023) we were having one of the best days in our lifes:
          the Kiss concert.
        </p>
        ...
        <p>
          I could say that life could be tricky... but to be fair, it sucks sometimes. And sometimes
          it sucks consecutively.
        </p>
        ...
        <p>
          We do not pretend to say how you live your grief, we just want to help you to be able to
          try to deal with this pain or help your family to know how you wish them to react when you
          no longer be part of this world, knowing that you are not alone and your pain still is
          UNIQUE.
        </p>
        ...
        <p>
          Life cycle can be unfair and painful, you can curse, share your emotions, but at the same
          time, remember that from death, we can have life. We can learn, grow, and love. When a
          tree dies, it nourishes the soil so that other plants can grow. While we lose our loved
          ones, new lives are being born. One day, we celebrate the gift of life; the next, we feel
          the pain of its cycle.
        </p>
